...
def get_gauges_json_path() -> Optional[str]:
...
def load_gauges_data() -> Optional[Dict[str, Any]]:
...
def format_for_display(site_data: Dict[str, Any]) -> Dict[str, Any]:
    """
...
def get_all_river_levels() -> Union[Response, Tuple[Response, int]]:
    """
...
def get_river_level(site_id: str) -> Union[Response, Tuple[Response, int]]:
    """
...
def get_river_level_by_name(name: str) -> Union[Response, Tuple[Response, int]]:
    """
...
@app.route('/')
def index() -> Union[Response, Tuple[str, int]]:
...
def gauges_json() -> Union[Response, Tuple[Response, int]]:
...
def get_usgs_history(site_id: str) -> Union[Response, Tuple[Response, int]]:
    """
    ...
    try:
        ...
        def downsample(data_list: List[Dict[str, Any]], target_points: int = 200) -> List[Dict[str, Any]]:
...
def get_tva_history(site_code: str) -> Union[Response, Tuple[Response, int]]:
    """
...
def get_tva_stats(site_code: str) -> Union[Response, Tuple[Response, int]]:
    """
...
def get_ocoee_combined_history() -> Union[Response, Tuple[Response, int]]:
    """
...
def get_rainfall_today() -> Union[Response, Tuple[Response, int]]:
    """
...
def get_river_rainfall(river_name: str) -> Union[Response, Tuple[Response, int]]:
    """
...
def get_river_rainfall_weekly(river_name: str) -> Union[Response, Tuple[Response, int]]:
    """
...
def get_paddle_log() -> Union[Response, Tuple[Response, int]]:
    """
...
def add_paddle_event() -> Union[Response, Tuple[Response, int]]:
    """
...
def get_paddle_stats() -> Union[Response, Tuple[Response, int]]:
    """
